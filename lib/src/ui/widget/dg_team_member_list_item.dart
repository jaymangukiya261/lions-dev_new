...
import 'package:lions/src/ui/screens/dg_member_profile.dart';
import 'package:lions/src/ui/widget/avatar.dart';
import 'package:lions/src/utils/utils.dart';
import '../../constants.dart';

class DgTeamMemberListItem extends StatelessWidget {
  CabinetMember member;

  DgTeamMemberListItem({Key key, @required this.member}) : super(key: key);
      ...
      child: InkWell(
        onTap: () {
          var router = new MaterialPageRoute(builder: (BuildContext context) {
            return DgMemberProfile(member: member);
          });
