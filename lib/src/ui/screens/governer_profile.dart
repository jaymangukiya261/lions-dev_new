...
class GovernerProfile extends StatelessWidget {
  Governer member;
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (member.alternetPhoneNumber != null)
                              InkWell(
                                onTap: () {
                                  Utils.makePhoneCall(
                                      'tel://${member.alternetPhoneNumber}');
                                },
                                child: Row(
                                  children: [
                                    Icon(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  MemberProfileItem(title: "Postal", value: member.pinCode),
                ],
              ),
            ),
          ],
