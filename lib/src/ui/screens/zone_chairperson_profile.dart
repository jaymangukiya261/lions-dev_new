...
class ZoneChairpersonProfile extends StatelessWidget {
  CabinetMember member;

  ZoneChairpersonProfile({
    Key key,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (member.club.zone.region != null)
                              AutoSizeText(
                                "${member.club.zone.name} (${member.club.zone.region.name})",
                                maxLines: 2,
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
                                    color: Colors.white,
                            ...
                            if (member.alternatePhoneNumber != null)
                              InkWell(
                                onTap: () {
                                  Utils.makePhoneCall(
                                      'tel:${{member.alternatePhoneNumber}}');
                                },
                                child: Row(
                                  children: [
                                    Icon(
