...
import 'package:lions/src/ui/widget/downloadable_list_item.dart';
import 'package:lions/src/blocs/downloads_bloc.dart';
...
class _DownloadListState extends State<DownloadList> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Expanded(
            child: StreamBuilder(
              stream: bloc.allDownloadable,
              builder: (context, AsyncSnapshot<List<Downloadable>> snapshot) {
                if (snapshot.hasData) {
  ...
  Widget buildList(List<Downloadable> data) {
    return ListView.builder(
        ...
        */
        itemBuilder: (BuildContext context, int index) {
          return DownladableListItem(
            downloadable: data[index],
          );
        });
  }
}
