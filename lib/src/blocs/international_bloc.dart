...
class InternationalBloc {
  ...
  Observable<List<Member>> get allInternationalMembers => _fetcher.stream;

  fetchAllInternationalMembers() async {
    MemberResponse response = await _repository.fetchInternationalMembers();
